                      ...
                      >
                        ...
                        <div className="px-4 pb-4 pt-2 border-t border-[#2a2a2a]">
                          <button
                            ...
                            className="w-full py-3 bg-red-500 hover:bg-red-600 text-white rounded-lg flex items-center justify-center gap-2 transition-all font-semibold text-sm shadow-lg shadow-red-500/20 hover:shadow-red-500/40"
                          >
